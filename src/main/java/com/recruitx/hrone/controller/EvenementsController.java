...
public class EvenementsController {
    ...
    private final ParticipationEvenementService pes = new ParticipationEvenementService();
    ...
    @FXML
    private void goToParticipations(javafx.event.ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/recruitx/hrone/participations.fxml"));
    ...
    private void openChatbot(javafx.event.ActionEvent event) {
        // Optionnel : redirection vers chatbot
    }
